...
int main() {
    ...
    **************************************************************************/        
    ...
    while (t <= tmax)
    {   
        std::cout << "Simulating timestep " << ti << " at time " << t << " | dx="<< dx << " | mu=" << mu << std::endl;
        ...
        for (int j=NG; j<Ny+NG; j++){
            for (int i=NG; i<Nx+NG; i++){
                ...
                invRe = mu/(rho*sqrt(u[i][j]*u[i][j] + v[i][j]*v[i][j])*L) + 0.0001;
                ...
                std::cout << i << "\t" << j << "\t";
                std::cout << u[i][j] << "\t" << u[i-1*sx][j] << "\t" << u[i-2*sx][j] << " | invRe=" << invRe << std::endl;
                // d2udy2
