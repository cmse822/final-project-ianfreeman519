...
int main(int argc, char* argv[]) {
    ...
    **************************************************************************/
    ...
    // Timer for writing step times to file
    ...
    **************************************************************************/        
    ...
    if (write_velocities) {
        writeToCsv(u, "output_serial/u_" + directory_name + "_" +  std::to_string(ti) + ".csv");
        writeToCsv(v, "output_serial/v_" + directory_name + "_" +  std::to_string(ti) + ".csv");
        writeToCsv(Re, "output_serial/Re_" + directory_name + "_" +  std::to_string(ti) + ".csv");
    }
    ...
    {   
        ...
        // storing it in inner_loop_timer
        inner_loop_timer[ti] = duration.count();
        // Output to file
    ...
    write1DToCsv(inner_loop_timer, "output_serial/timer_" + directory_name + ".csv");
    return 0;
}