...
int main() {
    ...
    **************************************************************************/        
    ...
    {   
        ...
        if (write_tracers) {
            for (int tri; tri < N_tracer; tri++) {
                int i = findClosestIndex(x, tracer_position[0][tri]);
                int j = findClosestIndex(y, tracer_position[1][tri]);
